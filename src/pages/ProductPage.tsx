...
const ProductPage = () => {
    ...
    useEffect(() => {
        ...
        api.get(`/products/${id}`)
            .then(({ data }) => {
                ...
                const categorySlug = typeof data.product.category === 'object' ? data.product.category.slug : data.product.category;
    ...
    const handlePlus = () => {
        ...
        const getCategoryName = () => {
            ...
            return product.category ? product.category.replace(/-/g, ' ') : 'Uncategorized';
        };
    return (
        <div className="min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
                    ...
                    <span>/</span>
                    <Link to={`/products?category=${getCategorySlug()}`} className="hover:text-app-green transition-colors capitalize">
                        {getCategoryName()}
                    </Link>
                    <span>/</span>
                ...
                <div className="bg-white/50 rounded-2xl overflow-hidden">
                    <div className="grid md:grid-cols-2 gap-0">
                        ...
                        <div className="p-6 md:p-10 flex flex-col justify-center">
                            <span className="text-xs font-medium text-app-text-light tracking-wider mb-2 capitalize">{getCategoryName()}</span>
                    ...
                    <section className="mt-12 mb-44">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-sm text-app-text-light mt-1">More from {getCategoryName()}</p>
                            </div>
                            <Link className="text-sm font-semibold text-app-orange hover:text-app-orange-dark flex items-center gap-1 transition-colors" to={`/products?category=${getCategorySlug()}`}>
