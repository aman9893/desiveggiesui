...
export default function AdminProducts() {
    ...
    const handleMarkOutOfStock = async (id: string, name: string) => {
        ...
        try {
            ...
            toast.success("Product marked as out of stock", { duration: 3000 });
            fetchProducts();
        } catch (error: any) {
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-zinc-500">{typeof product.category === 'object' ? product.category.name : product.category || "Uncategorized"}</p>
                                                </div>
                                            </div>
                                        </td>
