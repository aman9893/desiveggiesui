import { TruckIcon, LeafIcon, MapPinIcon, PhoneIcon, MailIcon } from "lucide-react";
...
export const appPromoBannerData = {
    ...
    description: "Download the DesiVeggies  app for exclusive deals, real-time tracking, and the freshest selection delivered right to your door.",
};
